...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'Phong', now()-1, 'keumtae.kim', now()-1);
 ...
 , '1', 'Danh', now()-2, 'keumtae.kim', now()-2);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'Danh', now()-3, 'keumtae.kim', now()-3);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'Phong', now()-4, 'keumtae.kim', now()-4);
...
INSERT INTO post (title, body, user_id, created_by, created_date, last_modified_by, last_modified_date) VALUES
 ...
 , '1', 'Phong', now()-5, 'keumtae.kim', now()-5);
